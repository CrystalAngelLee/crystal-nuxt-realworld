...
2. 将[realworld资源](https://github.com/gothinkster/realworld-starter-kit/blob/master/FRONTEND_INSTRUCTIONS.md) 资源部分导入到文件中
3. 重启服务，F12验证资源加载
...
2. 将[realworld资源](https://github.com/gothinkster/realworld-starter-kit/blob/master/FRONTEND_INSTRUCTIONS.md) 中Header/Footer 部分copy到文件中
...
4. 创建主页面相关
   ...
   将[realworld资源](https://github.com/gothinkster/realworld-starter-kit/blob/master/FRONTEND_INSTRUCTIONS.md) 中Home 部分copy到文件中
